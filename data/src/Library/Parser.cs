...
public class Parser
{
    ...
    public UnitCard ParseUnitCard()
    {
        ...
        return new UnitCard(Name, TokenValues.unitcard, Path, powers, Phrase, Position, Damage);       
    }
    ...
    public LeaderCard ParseLeaderCard()
    {
        ...
        return new LeaderCard(Name, TokenValues.leadercard, Path, powers, Phrase);
    }
    ...
    public EffectCard ParseEffectCard()
    {
        ...
        return new EffectCard(Name, TokenValues.effectcard, Path, powers, Position);
    }    
}